...
USE_CAPTION_FILTER = bool(environ.get('RM Mσʋιҽ Fʅιx-', True))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6976744562 6964538561').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002196942185').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesAdda24_72')
...
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/MoviesAdda24_72')
